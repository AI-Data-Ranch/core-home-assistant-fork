...
class AppleTvMediaPlayer(
    AppleTVEntity,
    MediaPlayerEntity,
    PowerListener,  # type: ignore[misc,unused-ignore]
    AudioListener,  # type: ignore[misc,unused-ignore]
    PushListener,  # type: ignore[misc,unused-ignore]
):
    ...
    def app_id(self) -> str | None:
        ...
        if (
            ...
            return app.identifier  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def app_name(self) -> str | None:
        ...
        if (
            ...
            return app.name  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_content_id(self) -> str | None:
        ...
        if self._playing:
            return self._playing.content_identifier  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def volume_level(self) -> float | None:
        ...
        if self.atv and self._is_feature_available(FeatureName.Volume):
            return self.atv.audio.volume / 100.0  # type: ignore[no-any-return,unused-ignore]  # from percent
        return None
    ...
    def media_duration(self) -> int | None:
        ...
        if self._playing:
            return self._playing.total_time  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_position(self) -> int | None:
        ...
        if self._playing:
            return self._playing.position  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_image_hash(self) -> str | None:
        ...
        if (
            ...
            return self.atv.metadata.artwork_id  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_title(self) -> str | None:
        ...
        if self._playing:
            return self._playing.title  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_artist(self) -> str | None:
        ...
        if self._playing and self._is_feature_available(FeatureName.Artist):
            return self._playing.artist  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_album_name(self) -> str | None:
        ...
        if self._playing and self._is_feature_available(FeatureName.Album):
            return self._playing.album  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def media_series_title(self) -> str | None:
        ...
        if self._playing and self._is_feature_available(FeatureName.SeriesName):
            return self._playing.series_name  # type: ignore[no-any-return,unused-ignore]
        return None
    ...
    def shuffle(self) -> bool | None:
        ...
        if self._playing and self._is_feature_available(FeatureName.Shuffle):
            return self._playing.shuffle != ShuffleState.Off  # type: ignore[no-any-return,unused-ignore]
        return None

    def _is_feature_available(self, feature: FeatureName) -> bool:
        """Return if a feature is available."""
        if self.atv and self._playing:
            return self.atv.features.in_state(FeatureState.Available, feature)  # type: ignore[no-any-return,unused-ignore]
        return False
